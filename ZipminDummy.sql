...
-- CHOMP 테이블 더미데이터
insert into chomp values (seq_chomp_id.NEXTVAL, '여름 인기 녹차 아이스크림', TO_DATE('25/06/01','RR/MM/DD'), TO_DATE('25/07/31','RR/MM/DD'), null, 'vote'); -- 1
insert into chomp values (seq_chomp_id.NEXTVAL, '녹차 디저트 페어링', sysdate, sysdate, '녹차의 고소함과 쌉싸름함을 살리기 위해 당도 낮은 디저트와 짝을 지었습니다: 말차 파운드 케이크, 팥앙금, 구운 아몬드와 피칸, 70% 다크초콜릿이 잘 어울립니다. 아이스크림은 서빙 5분 전 냉장에서 숨을 돌리면 향이 열리고 질감이 부드러워집니다. 함께 마실 음료는 무가당 보리차나 진한 말차라떼를 추천하며, 차갑게 식힌 접시에 담아 녹는 속도를 늦추세요.', 'megazine'); -- 2
insert into chomp values (seq_chomp_id.NEXTVAL, '가을 녹차 페스티벌', TO_DATE('25/09/20','RR/MM/DD'), TO_DATE('25/10/05','RR/MM/DD'), '행사장 시음 부스 운영, 말차 아이스크림 라이브 쿠킹 쇼와 원재료 토크 세션, 스탬프 투어 완주 굿즈 증정, 현장 한정 1+1 쿠폰으로 다양한 메뉴를 합리적으로 즐길 수 있습니다.', 'event'); -- 3
insert into chomp values (seq_chomp_id.NEXTVAL, '딸기 아이스크림 선호도', TO_DATE('25/05/01','RR/MM/DD'), TO_DATE('25/06/30','RR/MM/DD'), null, 'vote'); -- 4
insert into chomp values (seq_chomp_id.NEXTVAL, '저칼로리 아이스크림 비교', sysdate, sysdate, '세 가지 저칼로리 제품을 100ml 기준 열량, 당류, 단백질, 공기함량(overrun), 식감으로 비교했습니다. 감미료는 에리스리톨과 알룰로스 조합이 뒷맛이 깔끔했고, 레시틴 기반 유화제가 안정적이었습니다. 고형분이 낮을수록 얼음결이 커지므로 24시간 숙성 후 섭취하면 질감이 개선됩니다. 다이어트 중이라면 1회 제공량 80ml를 권장합니다.', 'megazine'); -- 5
insert into chomp values (seq_chomp_id.NEXTVAL, '홈메이드 녹차 젤라토', sysdate, sysdate, '우유 500ml, 생크림 200ml, 설탕 90g, 말차 10~12g, 소금 한 꼬집을 사용합니다. 80도C까지 가열해 설탕과 말차를 완전히 녹인 뒤 차게 식혀 4시간 숙성하세요. 아이스크림 메이커가 없으면 지퍼백 이중 포장 후 냉동고에서 30분 간격으로 꺼내 흔들어 얼음결을 깨면 됩니다. 덩어리가 지면 체에 한 번 거르면 색과 질감이 한층 고와집니다.', 'megazine'); -- 6
insert into chomp values (seq_chomp_id.NEXTVAL, '프리미엄 vs 가성비', sysdate, sysdate, '프리미엄 라인은 우유 고형분과 생크림 함량이 높고 일본산 또는 국내산 고급 말차를 사용해 향이 길게 남습니다. 가성비 라인은 당도와 바닐라향이 강해 첫맛은 또렷하지만 여운은 짧습니다. 원재료표에서 포도당 시럽 비율, 합성착향료 여부, 고형분 수치를 확인하면 품질을 가늠할 수 있습니다. 예산이 허락하면 프리미엄 1스쿱, 일상 간식으론 가성비 라인을 추천합니다.', 'megazine'); -- 7
insert into chomp values (seq_chomp_id.NEXTVAL, '비건 아이스크림 가이드', sysdate, sysdate, '비건 아이스크림은 코코넛밀크, 오트밀크, 아몬드밀크 베이스가 대표적입니다. 코코넛은 향이 뚜렷하고 질감이 진하며, 오트는 곡물 향과 점성이 좋아 녹차와 조화롭습니다. 점도 조절은 구아검이나 잔탄검이 무난합니다. 라벨에서 동물성 유래 성분, 팜유, 카라기난 사용 여부를 확인하고, 견과 알레르기가 있다면 아몬드 베이스는 피하세요.', 'megazine'); -- 8
insert into chomp values (seq_chomp_id.NEXTVAL, '여름 디저트 핫플', sysdate, sysdate, '여름철 인기 매장은 대기 시간, 시그니처 메뉴, 가격대가 명확합니다. 시그니처는 말차 소프트, 말차 브라우니 선데, 말차 샌드 쿠키 등이며 오후 3시 이후 대기가 길어지므로 오픈 시간대 방문을 추천합니다. 테이크아웃 시 냉매팩을 준비하면 녹는 속도를 줄일 수 있고, 사진은 콘이 녹기 전 10초가 골든타임입니다.', 'megazine'); -- 9
insert into chomp values (seq_chomp_id.NEXTVAL, '편의점 신상 모음', sysdate, sysdate, '편의점 신상 녹차 라인업을 용량 대비 가격, 당류, 우유 함량, 말차 함량 기준으로 비교했습니다. 진한 녹차향을 원하면 우유 함량이 높은 제품을, 가벼운 간식은 샤베트 타입을 추천합니다. 포장 뒷면에서 당류 15g 이하 제품을 우선 선택하고, 한정판은 출시 첫 주에 구매하는 것이 안전합니다.', 'megazine'); -- 10
insert into chomp values (seq_chomp_id.NEXTVAL, '녹차 바닐라 믹스의 매력', sysdate, sysdate, '녹차와 바닐라를 7:3으로 섞으면 녹차의 쌉싸름함이 중심을 잡고, 5:5는 가장 부드러운 밸런스를 만듭니다. 가정에서는 두 스쿱을 한 볼에 담아 주걱으로 두 번만 가볍게 섞어 스월 무늬를 살리세요. 토핑은 코코아 닙스나 볶은 콩가루가 잘 어울리고, 바삭함을 더하려면 얇은 웨이퍼를 곁들이면 좋습니다.', 'megazine'); -- 11
insert into chomp values (seq_chomp_id.NEXTVAL, '제철 과일과 녹차 아이스크림 페어링', sysdate, sysdate, '산미 있는 복숭아·자두는 말차의 쌉싸름함을 부드럽게 잡아주고, 당도가 높은 멜론·바나나는 고소한 풍미를 강화합니다. 과일은 차갑게, 아이스크림은 서빙 5분 전 냉장 숙성 후 담아 온도 대비를 만들면 향이 확 살아납니다.', 'megazine'); -- 12
insert into chomp values (seq_chomp_id.NEXTVAL, '여름에 가장 맛있는 과일', TO_DATE('25/05/15','RR/MM/DD'), TO_DATE('25/08/15','RR/MM/DD'), null, 'vote'); -- 13
insert into chomp values (seq_chomp_id.NEXTVAL, '홈카페 말차 플로트 레시피', sysdate, sysdate, '진한 말차 2작은술을 60ml의 뜨거운 물에 푼 뒤, 차갑게 식힌 탄산수 200ml와 섞고 녹차 아이스크림 1스쿱을 띄우면 청량한 플로트가 완성됩니다. 거품이 과하면 얼음 2개로 탄산을 눌러 주고, 마무리는 레몬 제스트 한 꼬집.', 'megazine'); -- 14
insert into chomp values (seq_chomp_id.NEXTVAL, '초코 아이스크림 위크', TO_DATE('25/10/10','RR/MM/DD'), TO_DATE('25/10/20','RR/MM/DD'), '카카오 원산지별 초코 아이스크림 테이스팅 플라이트, 시그니처 토핑 무료 업그레이드, SNS 해시태그 인증 추첨 혜택, 멤버십 더블 포인트, 매일 17시 타임세일로 한정 수량 특별가를 제공합니다.', 'event'); -- 15
insert into chomp values (seq_chomp_id.NEXTVAL, '연말 디저트 대전', TO_DATE('25/12/10','RR/MM/DD'), TO_DATE('25/12/31','RR/MM/DD'), '셰프 팝업 디저트 쇼케이스와 페어링 클래스, 연말 기프트 패키지 및 한정 콜라보 메뉴 출시, 사전 예매자 웰컴 드링크 제공, 스탬프 랠리 완주 시 경품을 증정합니다.', 'event'); -- 16
insert into chomp values (seq_chomp_id.NEXTVAL, '편의점 한정판 캘린더 가이드', sysdate, sysdate, '신상 아이스크림은 보통 화요일 입고 비중이 높고, 한정판은 첫 주 수량이 핵심입니다. 출시 알림은 브랜드 앱 푸시를 켜 두고, 인기 제품은 개점 직후 방문이 안전합니다. 보관 이동은 보냉 파우치와 소형 아이스팩 조합이 효율적입니다.', 'megazine'); -- 17
insert into chomp values (seq_chomp_id.NEXTVAL, '초코 vs 바닐라', TO_DATE('25/04/01','RR/MM/DD'), TO_DATE('25/05/01','RR/MM/DD'), null, 'vote'); -- 18
insert into chomp values (seq_chomp_id.NEXTVAL, '녹차 아이스크림 건강 체크포인트', sysdate, sysdate, '말차의 카테킨이 주는 쌉싸름함은 당도 체감을 낮춰주지만, 실제 당류는 라벨(100ml 기준 15g 이하 권장)로 확인하세요. 1회 제공량은 80~100ml가 적당하며, 단백질을 올리고 싶다면 무가당 그릭요거트를 한 스푼 곁들이면 포만감이 좋아집니다.', 'megazine'); -- 19
insert into chomp values (seq_chomp_id.NEXTVAL, '여름 한정 시식회', TO_DATE('25/07/01','RR/MM/DD'), TO_DATE('25/07/15','RR/MM/DD'), '여름 신상 아이스크림 전 라인업 시식 존 운영, 테이스팅 패스 보유 시 전 메뉴 1회 시식, 어린이 체험 부스와 포토존, 보냉팩 무료 증정, 위생 수칙 준수로 안심하고 즐길 수 있는 행사입니다.', 'event'); -- 20
insert into chomp values (seq_chomp_id.NEXTVAL, '최애 녹차 브랜드', TO_DATE('25/08/01','RR/MM/DD'), TO_DATE('25/09/30','RR/MM/DD'), null, 'vote'); -- 21
insert into chomp values (seq_chomp_id.NEXTVAL, '가을에 어울리는 아이스크림', TO_DATE('25/09/01','RR/MM/DD'), TO_DATE('25/10/15','RR/MM/DD'), null, 'vote'); -- 22
commit;
