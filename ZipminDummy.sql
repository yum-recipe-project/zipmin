...
INSERT INTO classes VALUES (seq_classes_id.NEXTVAL, '계절김치 마스터 클래스', '한식', '3ea892bb6a424df0ac11146e79fa0bff.png', '제철 채소로 김치를 만들어보는 마스터 클래스입니다.', '서울 은평구', TO_DATE('2025-04-05', 'YYYY-MM-DD'), TO_DATE('2025-10-11', 'YYYY-MM-DD'), TO_DATE('1970-01-01 11:00', 'YYYY-MM-DD HH24:MI'), TO_DATE('1970-01-01 13:30', 'YYYY-MM-DD HH24:MI'), TO_DATE('2025-10-08', 'YYYY-MM-DD'), 6, '앞치마, 밀폐용기, 고무장갑', 1, 4);
