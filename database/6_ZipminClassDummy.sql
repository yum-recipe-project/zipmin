...
-- ============================
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+13/24, '위스키에 대한 기본적인 지식', 1);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+13/24, '위스키 선택 요령', 1);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+13/24, '위스키와 음식의 페어링 법칙', 1);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+13/24, '위스키 보관 요령', 1);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+13/24, '위스키 시음', 1);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '커리큘럼 소개', 2);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '이론 설명', 2);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '실전 (각 요리별로 상이)', 2);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '반죽', 3);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '오븐에 굽기', 3);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '글레이즈드와 초콜릿 중탕', 3);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '마들렌 완성 및 포장', 3);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '약과틀을 이용해 약과의 모양 만들기', 4);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '만들어진 약과를 튀기기', 4);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '약과를 집청에 묻히기', 4);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '집청이 묻은 약과를 굳히기', 4);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '커리큘럼 소개', 5);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '이론 설명', 5);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '실전 (각 요리별로 상이)', 5);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '스티밍 배우기 (우유 거품 내기)', 6);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '안정화 연습 (커피와 우유 섞기)', 6);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '몽키헤드 띄우기 (꼬리 없는 하트)', 6);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '면하트 띄우기 (무결 하트)', 6);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '타르트를 오븐에 굽기', 7);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '아몬드크림을 반죽하기', 7);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '생크림 휘핑', 7);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '과일 얹기', 7);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '박스 포장', 7);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '다양한 과일을 활용한 시그니처 메뉴 레시피', 8);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '티를 활용한 색감 좋은 음료 레시피', 8);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '초보자도 쉽게 만들 수 있는 목테일 음료 레시피', 8);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24+30/1440, '다양한 원료에 대한 이해와 활용 방법', 8);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '생두, 로스팅, 드립백까지 커피의 여정', 9);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '나만의 커피 취향 알아보기', 9);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '실습: 내 손으로 만드는 나만의 드립백!', 9);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '손글씨 태그 만들기', 9);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '내가 만든 드립백으로 함께 커피 내려보기', 9);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '아이스브레이킹: 댕댕이 인사 및 소개', 10);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '사용되는 재료와 영양 간단 소개', 10);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '케이크 만들기', 10);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '포장과 사진', 10);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '휘핑크림 제조', 11);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '크림 샌딩 및 아이싱', 11);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '케이크 꾸미기', 11);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+12/24, '케이크 포장', 11);

INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '시음회', 12);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '고두밥 식히기', 12);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '혼화 (치대기)', 12);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '입항', 12);
INSERT INTO class_schedule VALUES (seq_class_schedule_id.NEXTVAL, DATE '1970-01-01'+10/24, DATE '1970-01-01'+11/24+30/1440, '기념사진 및 마무리', 12);
