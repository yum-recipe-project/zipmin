...
public enum ClassErrorCode implements Code {
    ...
    CLASS_TARGET_READ_LIST_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "교육대상 목록 조회 실패"),
    CLASS_TARGET_READ_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "교육대상 조회 실패"),
    ...
    CLASS_SCHEDULE_READ_LIST_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "교육일정 목록 조회 실패"),
    CLASS_SCHEDULE_READ_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "교육일정 조회 실패"),
    ...
    CLASS_TUTOR_READ_LIST_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "강사 목록 조회 실패"),
    CLASS_TUTOR_READ_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "강사 조회 실패"),
    ...
    CLASS_APPLY_READ_LIST_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "신청 목록 조회 실패"),
    CLASS_APPLY_READ_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "신청 조회 실패"),
    ...
    CLASS_ALREADY_ENDED(HttpStatus.FORBIDDEN, "투표 종료 후 접근 시도"),
