...
public enum ClassSuccessCode implements Code {
    ...
    CLASS_COUNT_ATTEND_SUCCESS(HttpStatus.OK, "클래스 출석 집계 성공"),
    
    CLASS_APPLY_CREATE_SUCCESS(HttpStatus.CREATED, "클래스 신청 작성 성공"),
    CLASS_APPLY_READ_LIST_SUCCESS(HttpStatus.OK, "클래스 신청 목록 조회 성공"),
    CLASS_APPLY_READ_SUCCESS(HttpStatus.OK, "클래스 신청 조회 성공"),
    CLASS_APPLY_UPDATE_SUCCESS(HttpStatus.OK, "클래스 신청 수정 성공"),
    CLASS_APPLY_DELETE_SUCCESS(HttpStatus.OK, "클래스 신청 삭제 성공");
