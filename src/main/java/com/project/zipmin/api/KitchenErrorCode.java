...
public enum KitchenErrorCode implements Code {
	...
	// 인증/인가
	KITCHEN_UNAUTHORIZED_ACCESS(HttpStatus.UNAUTHORIZED, "로그인되지 않은 사용자"),
	KITCHEN_FORBIDDEN(HttpStatus.FORBIDDEN, "권한 없는 사용자의 접근"),
    ...
    KITCHEN_READ_LIST_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "키친가이드 목록 조회 실패"),
