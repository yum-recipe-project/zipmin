...
public enum MegazineErrorCode implements Code {
	...
	MEGAZINE_FORBIDDEN(HttpStatus.FORBIDDEN, "권한 없는 사용자"),
	
	MEGAZINE_INVALID_INPUT(HttpStatus.BAD_REQUEST, "입력값이 유효하지 않음"),
	MEGAZINE_INVALID_PERIOD(HttpStatus.BAD_REQUEST, "기간이 유효하지 않음"),
	...
	MEGAZINE_FILE_UPLOAD_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "매거진 파일 업로드 실패"),
