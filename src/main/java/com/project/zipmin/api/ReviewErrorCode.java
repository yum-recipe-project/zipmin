...
public enum ReviewErrorCode implements Code {
    ...
    REVIEW_UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "로그인되지 않은 사용자"),
    REVIEW_FORBIDDEN(HttpStatus.FORBIDDEN, "권한 없는 사용자"),
    ...
    REVIEW_COUNT_FAIL(HttpStatus.BAD_REQUEST, "리뷰 집계 실패"),
