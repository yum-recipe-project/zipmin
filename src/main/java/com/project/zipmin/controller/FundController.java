...
public class FundController {
    ...
    public ResponseEntity<?> readUserWithdrawList(
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<WithdrawReadResponseDto> withdrawPage = withdrawService.readWithdrawPageByUserId(id, pageable);
    ...
    public ResponseEntity<?> createUserWithdrawRequest(
        ...
        WithdrawReadResponseDto withdrawResponseDto = withdrawService.createWithdraw(withdrawRequestDto);
