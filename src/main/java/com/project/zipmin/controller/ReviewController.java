...
public class ReviewController {
	...
	@ApiResponses(value = {
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(
	            ...
	            content = @Content(
	                    mediaType = "application/json",
	                    schema = @Schema(implementation = ReviewReportSuccessResponse.class))),
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(
	            responseCode = "400",
	            description = "리뷰 신고 실패",
	            content = @Content(
	                    mediaType = "application/json",
	                    schema = @Schema(implementation = ReviewReportFailResponse.class))),
	    @io.swagger.v3.oas.annotations.responses.ApiResponse(
				responseCode = "400",
	...
	public ResponseEntity<?> reportReview(
			@Parameter(description = "리뷰의 일련번호") @PathVariable int id,
			@Parameter(description = "리뷰 신고 작성 요청 정보") @RequestBody ReportCreateRequestDto reportRequestDto) {
