...
public class RevenueService {
	...
	public Page<FundReadResponseDto> readUserRevenuePageById(Integer userId, Pageable pageable) {
		...
		// 후원받은 내역 목록 조회
 		...
 		for (Fund fund : fundPage) {
 			FundReadResponseDto fundDto = fundMapper.toReadRevenueResponseDto(fund);
 		...
 		System.err.println(fundDtoList);
