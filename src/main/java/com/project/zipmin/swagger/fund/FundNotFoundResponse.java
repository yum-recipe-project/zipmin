...
@Schema(name = "FundNotFoundResponse")
public class FundNotFoundResponse {

    @Schema(example = "FUND_NOT_FOUND", description = "성공 코드")
    public String code;

    @Schema(example = "해당 후원을 찾을 수 없음", description = "성공 메시지")
