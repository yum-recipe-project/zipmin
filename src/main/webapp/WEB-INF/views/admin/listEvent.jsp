			...
			<div class="body-wrapper">
				...
				<div class="container-fluid">
					...
					<div class="nav_wrap">
						...
						<a href="/admin/listEvent.do" class="active"><img src="/images/cooking/arrow_right.png"><span>이벤트 관리</span></a>
					</div>
					...
					<div class="bar">
						<div class="tab">
							<ul>
								...
								<li class="btn_tab"><a href="/admin/listEvent.do" class="active"><span>이벤트 관리</span></a></li>
							</ul>
						</div>
						<button type="button" class="btn btn-info m-1" onclick="location.href='/admin/writeEvent.do';">
							<i class="ti ti-plus fs-4"></i> 이벤트 작성하기
						</button>
					</div>
