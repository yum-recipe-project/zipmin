					...
					<div class="bar">
						<div class="tab">
							<ul>
								...
								<li class="btn_tab"><a href="/admin/listVote.do" class="active"><span>투표 관리</span></a></li>
						...
						<button type="button" class="btn btn-info m-1" onclick="location.href='/admin/writeVote.do';">
							<i class="ti ti-plus fs-4"></i> 투표 작성하기
						</button>
					</div>
