...
<div id="reviewWrap" class="review_wrap">
	<!-- 리뷰 헤더 -->
	<div class="review_header">
		...
		<div class="review_order">
			...
			<button class="btn_sort_small" data-sort="score-desc">별점순</button>
	...
	<form id="writeReviewForm" class="review_write">
		...
		<!-- 로그인 한 경우 -->
		<div id="reviewLoginState">
			<div class="login_user">
				<img id="writeReviewAvatar">
			...
			<div id="writeReviewStarGroup" class="star_group">
				...
				<input type="hidden" id="writeReviewStar" value="1">
			</div>
			<!-- 리뷰 입력창 -->
